				...
				<div class="col-xs-3 col-sm-6">
					<a target="_blank" href="https://home.cern">
						<div class="collaborator-logo">
							<img src="img/collaborators/CERN_intro2.jpg" class="img-fluid" alt="CERN">
						</div>
					</a>
				</div>
				<div class="col-xs-3 col-sm-6">
			...
			<div class="container wow fadeInUp">
				...
				<div class="tab-content row justify-content-center">
					...
					<div role="tabpanel" class="col-lg-9 tab-pane fade" id="day-3">
						...
						<div class="row schedule-item">
							<div class="col-md-2"><time>Evening</time></div>
							<div class="col-md-10">
								<h4>Reception at Swiss Embassy</h4>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="details">
							...
							<p>Maxime Miraillet started his business in digital design services, with a focus on cutting-edge technologies
								such as aerial filming with drones. He was initially approached by the International School of Geneva to teach
								film and drone piloting to autistic children, as an alternative to classroom lessons. Fascinated with robotics
								since an early age, and with valuable knowledge of new technologies such as 3D printers and Virtual Reality, he
								assisted with the creation of Ecolint's STEM Center in Geneva. Now a STEM Project Leader for two years, he has
								used his passion and technical abilities to awaken students' curiosity through "making" things. Combining a
								variety of academic disciplines, such as maths and physics, and with the use of modern and traditional tools,
								he guides students through all the creative processes necessary to bring their projects to life.</p>
						</div>
					</div>
				</div>
				<br>
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-7 footer-contact">
						...
						<p>
							...
							<strong>Phone:</strong> <a href="tel:+918377833563">83778 33563</a><br>
							<strong>Email:</strong> <a href="mailto:prachi@lifelab.org.in">prachi@lifelab.org.in</a>
						</p>
						<p>
							Vinita Sharat (Shiv Nadar School)<br>
							<strong>Phone:</strong> <a href="tel:+919654143732">96541 43732</a><br>
